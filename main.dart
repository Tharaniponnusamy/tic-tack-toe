...
class _PlayerSelectionScreenState extends State<PlayerSelectionScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Select Symbols',style: TextStyle(color: Color.fromARGB(255, 0, 0, 0)),),
        backgroundColor: Color.fromARGB(255, 226, 223, 54),
      ),
      body: Container(
        padding: EdgeInsets.all(16.0),
        color: Color.fromARGB(255, 223, 73, 236),
        child: Center(
          child: Column(
              ...
              ElevatedButton(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    fontSize: 20,
                    fontWeight: FontWeight.bold,
                    color: Color.fromARGB(255, 4, 172, 12),
                  ),
                ),
              ),
            ],
...
class _TicTacToeScreenState extends State<TicTacToeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tic Tac Toe',style: TextStyle(color: const Color.fromARGB(255, 0, 0, 0)),),
        backgroundColor: Color.fromARGB(255, 188, 228, 45),
      ),
      body: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: Color.fromARGB(255, 195, 87, 228),
                      ),
                      child: Center(
                        child: Text(
                          board[row][col],
